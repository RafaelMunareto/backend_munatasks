                  ...
                  <div class="header">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        ...
                        <img src='https://github.com/RafaelMunareto/MunaTasksV2_flutter/blob/main/assets/icon/icon.png?raw=true' width='120', heigth='90'>
                        </td>
                      </tr>
                    </table>
                  </div>
                          ...
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td>
                                    ...
                                    <tr>
                                      <td align="center">
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                          <tbody>
                                            <tr>
                                              <td> <a href="http://munatask.com/#/auth/change/?code=${user}" target="_blank">Clique Aqui!</a> </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </td>
                                ...
                                <br>
                                <br>
                                <p>&nbsp; Caso não tenha solicitado por favor desconsidere.</p>
                                <br>
                              </td>
                            </tr>
                          </table>
